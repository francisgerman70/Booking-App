...
function importDefaultThemeSass(tree, filePath) {
    const igxPackage = angular_templates_1.resolveIgxPackage(angular_templates_1.NPM_PACKAGE);
    const sassImports = `
...
function importIgDefaultTheme(tree) {
    return __awaiter(this, void 0, void 0, function* () {
        const host = cli_core_1.createWorkspaceHost(tree);
...
function getDefaultProject(tree) {
    return __awaiter(this, void 0, void 0, function* () {
        const { workspace } = yield core_1.workspaces.readWorkspace("/", cli_core_1.createWorkspaceHost(tree));
...
function importDefaultThemeToAngularWorkspace(workspace, key) {
    ...
    const project = workspace.extensions.defaultProject ?
        workspace.projects.get(workspace.extensions.defaultProject) :
        workspace.projects.values().next().value;
    const target = (_a = project) === null || _a === void 0 ? void 0 : _a.targets.get(key);
    if (!target) {
