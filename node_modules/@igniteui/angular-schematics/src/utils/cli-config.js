...
function GetCliConfig(tree) {
    return __awaiter(this, void 0, void 0, function* () {
        let workspace;
        try {
            ({ workspace } = yield core_1.workspaces.readWorkspace("/", cli_core_1.createWorkspaceHost(tree)));
        }
        catch (e) {
...
function getPort(workspace) {
    ...
    const projectServe = (_b = (_a = project) === null || _a === void 0 ? void 0 : _a.targets.get("serve")) === null || _b === void 0 ? void 0 : _b.options;
    if (projectServe) {
